...
import type { ListObjectsCommandInput, PutObjectCommandInput, S3Client } from '@aws-sdk/client-s3';
...
export declare class S3 {
     ...
     */
    read(key: string, raw?: boolean): Promise<any>;
    /**
     * Write a file to s3
     *
     ...
     * @returns S3 instance {@link S3}
     */
    write(...params: [Omit<PutObjectCommandInput, `Bucket`>] | [string, Blob | Readable | ReadableStream | string]): Promise<this>;
}
