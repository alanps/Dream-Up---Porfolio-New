import type { Compiler, Configuration, Optimization, RuleSetRule } from '@roots/bud-support/webpack';
...
export interface Sync {
    ...
    'optimization.minimizer': Array<((compiler: Compiler) => void) | {
        apply: any;
    } | '...'>;
...
export interface Async {
    ...
    'resolve.aliasFields': Configuration['resolve']['aliasFields'] | undefined;
