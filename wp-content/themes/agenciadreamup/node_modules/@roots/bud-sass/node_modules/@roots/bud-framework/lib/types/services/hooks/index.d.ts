...
export default interface Hooks extends BaseService {
     ...
     * ```
     */
    on: <T extends `${keyof Registry.SyncStore & string}`>(id: T, input: Registry.SyncCallback[T]) => Bud;
    /**
     ...
     * ```
     */
    async: <T extends keyof Registry.AsyncStore>(id: T, value: Registry.AsyncCallback[T]) => Bud;
    /**
     * Register a recordset of functions or values to modify or replace existing values
     *
     * @example
     ...
     * ```
     */
    filter: <T extends keyof Registry.SyncStore>(id: T, callback?: Registry.SyncCallback[T]) => Registry.SyncRegistry[T];
    /**
     ...
     * ```
     */
    filterAsync: <T extends keyof Registry.AsyncRegistry & string>(id: T, fallback?: Registry.AsyncCallback[T]) => Promise<Registry.AsyncRegistry[T]>;
    /**
     * Execute an action
     */
    fire: <T extends `${keyof Registry.Events & string}`>(id: T, obj: Registry.Events[T]) => Promise<Bud>;
    /**
     * Store callback to an action handler
     */
    action: <T extends keyof Registry.Events & string>(id: T, ...input: Array<Registry.EventsCallback<T>>) => Bud;
}
