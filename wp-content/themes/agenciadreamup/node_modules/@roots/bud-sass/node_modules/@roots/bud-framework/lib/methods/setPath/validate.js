...
export const baseDir = ([basedir]) => {
    if (!isAbsolute(basedir)) {
        throw new InputError(`bud.setPath: when only one parameter is provided, it must be an absolute path.`, {
            props: {
...
export const stringPair = ([key, value]) => {
    if (!isString(value)) {
        throw new InputError(`bud.setPath: tried to set path with a non-string value`, {
            props: {
    ...
    if (!isString(key)) {
        throw new InputError(`bud.setPath: Tried to set path with a non-string key`, {
            props: {
