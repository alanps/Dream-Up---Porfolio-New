...
export class Module extends Service {
    ...
    async resolve(signifier, context) {
        if (signifier in this.resolved) {
            logger
                .scope(`module`)
                .info(`resolved ${signifier} to ${relative(this.app.context.basedir, this.resolved[signifier])} from cache`);
        ...
        try {
            ...
            logger
                .scope(`module`)
                .info(`[cache miss]`, `resolved ${signifier} to ${relative(this.app.context.basedir, normal)}`);
