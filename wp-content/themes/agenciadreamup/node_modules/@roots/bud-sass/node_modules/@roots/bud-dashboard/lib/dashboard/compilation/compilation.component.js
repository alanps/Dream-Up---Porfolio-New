...
const Compilation = ({ displayAssets, displayEntrypoints, compilation, context, }) => {
    ...
    const uncachedModuleCount = compilation.modules?.filter(module => !module.cached)?.length;
