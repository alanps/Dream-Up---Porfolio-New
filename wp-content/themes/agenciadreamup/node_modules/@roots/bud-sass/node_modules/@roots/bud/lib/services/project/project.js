    ...
    async buildAfter(bud) {
        ...
        try {
            ...
            await bud.fs.write(path, {
                ...
                minimize: bud.hooks.filter(`build.optimization.minimize`, undefined),
                ...
                extensions: {
                    ...
                    loaded: Object.entries(bud.extensions?.repository).map(([key, extension]) => ({
                        key,
        ...
        try {
            const path = bud.path(`@storage`, bud.label, `debug`, `build.config.yml`);
