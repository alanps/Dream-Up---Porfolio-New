...
export interface Options {
    ...
    include?: Array<((app: Bud) => string | RegExp) | string | RegExp> | undefined;
    exclude?: Array<((app: Bud) => string | RegExp) | string | RegExp> | undefined;
    ...
    generator?: ((app: Bud) => Output['generator']) | Output['generator'] | undefined;
}
/**
 * Output
 */
...
export interface Rule extends Base {
     ...
     */
    setUse(use: Array<`${keyof Items & string}` | Item> | ((use: Array<`${keyof Items & string}` | Item>) => Array<`${keyof Items & string}` | Item>)): this;
    /**
     * Use item
     */
