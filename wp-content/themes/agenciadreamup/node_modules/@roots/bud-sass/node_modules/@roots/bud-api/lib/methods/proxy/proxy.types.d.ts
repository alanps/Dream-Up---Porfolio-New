...
import type { HttpProxy, Options as ProxyOptions } from '@roots/bud-support/http-proxy-middleware';
...
export type ReplacementCallback = (replacements: ReplacementTuples | undefined) => ReplacementTuples;
