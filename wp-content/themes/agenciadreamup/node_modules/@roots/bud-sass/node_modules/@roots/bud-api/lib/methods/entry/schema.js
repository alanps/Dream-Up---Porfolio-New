 ...
 * entrypoints records
 */
export const inputRecord = z.record(entrypointSignifier, importItem.or(importArray));
/**
...
export const entrypointsRecord = z.record(entrypointSignifier, normalEntryValue);
/**
 * fn parameters
 */
