...
add_action('wp_enqueue_scripts', function () {
    if(!is_page('curriculum') && !is_page('calculadora') && !is_page('calculadora-mmc-mdc')){
        ...
        if(is_page('contato')){
            wp_enqueue_script( 'mask', '/wp-content/themes/agenciadreamup/resources/scripts/libs/jquery.mask.js', ['jquery'], '1.0.0', true );
            bundle('contato')->enqueue();
        }
    }

    if(is_page('curriculum')){
        wp_enqueue_script( 'curriculum', '/wp-content/themes/agenciadreamup/resources/scripts/curriculum.js', ['jquery'], '1.0.0', true );
        wp_enqueue_style( 'curriculum_stylesheet', '/wp-content/themes/agenciadreamup/resources/fonts/stylesheet.css' );
        wp_enqueue_style( 'curriculum', '/wp-content/themes/agenciadreamup/resources/styles/curriculum.css' );
    }

    if(is_page('calculadora')){
        wp_enqueue_script( 'calculadora', '/wp-content/themes/agenciadreamup/resources/scripts/calculadora.js', ['jquery'], '1.0.0', true );
        wp_enqueue_style( 'calculadora_stylesheet', '/wp-content/themes/agenciadreamup/resources/fonts/stylesheet.css' );
        wp_enqueue_style( 'calculadora_icomoon_stylesheet', '/wp-content/themes/agenciadreamup/resources/fonts/icomoon/icomoon_style.css' );
        wp_enqueue_style( 'calculadora', '/wp-content/themes/agenciadreamup/resources/styles/calculadora.css' );
        bundle('global_bundle')->enqueue();
    }

    if(is_page('calculadora-mmc-mdc')){
        wp_enqueue_style( 'calculadora-mmc-mdc', '/wp-content/themes/agenciadreamup/resources/styles/calculadora-mmc-mdc.css' );
        bundle('global_bundle')->enqueue();
    }
    ...
    if(is_page('personagem')){
        ...
        wp_enqueue_script( 'jquery.slimscroll.min', '/wp-content/themes/agenciadreamup/resources/scripts/libs/jquery.slimscroll.min.js', ['jquery'], '1.0.0', true );
        wp_enqueue_script( 'spinners.min', '/wp-content/themes/agenciadreamup/resources/scripts/libs/spinners.min.js', ['jquery'], '1.0.0', true );
        wp_enqueue_script( 'jquery.mousewheel-3.0.6.pack', '/wp-content/themes/agenciadreamup/resources/scripts/libs/source/jquery.mousewheel-3.0.6.pack.js', ['jquery'], '1.0.0', true );
        wp_enqueue_style( 'jquery.fancybox', '/wp-content/themes/agenciadreamup/resources/scripts/libs/source/jquery.fancybox.css' );
        wp_enqueue_script( 'jquery.fancybox.pack', '/wp-content/themes/agenciadreamup/resources/scripts/libs/source/jquery.fancybox.pack.js', ['jquery'], '2.1.5', true );
        wp_enqueue_style( 'jquery.fancybox-buttons', '/wp-content/themes/agenciadreamup/resources/scripts/libs/source/helpers/jquery.fancybox-buttons.css' );
        wp_enqueue_script( 'jquery.fancybox-buttons', '/wp-content/themes/agenciadreamup/resources/scripts/libs/source/helpers/jquery.fancybox-buttons.js', ['jquery'], '1.0.5', true );
        wp_enqueue_script( 'jquery.fancybox-media', '/wp-content/themes/agenciadreamup/resources/scripts/libs/source/helpers/jquery.fancybox-media.js', ['jquery'], '1.0.6', true );
        wp_enqueue_style( 'jquery.fancybox-thumbs', '/wp-content/themes/agenciadreamup/resources/scripts/libs/source/helpers/jquery.fancybox-thumbs.css' );
        wp_enqueue_script( 'jquery.fancybox-thumbs', '/wp-content/themes/agenciadreamup/resources/scripts/libs/source/helpers/jquery.fancybox-thumbs.js', ['jquery'], '1.0.7', true );
        wp_enqueue_script( 'personagem', '/wp-content/themes/agenciadreamup/resources/scripts/personagem.js', ['jquery', 'jquery.fancybox-thumbs', 'jquery.fancybox-media', 'jquery.fancybox-buttons', 'jquery.fancybox.pack'], '1.0.0', true );
        bundle('global_bundle')->enqueue();
    }
}, 100);
